...
contract PuppetV2Challenge is Test {
    ...
    function test_puppetV2() public checkSolvedByPlayer {
        // Dump all of the player's DVT into the thin Uniswap V2 pool, crashing
        // the token/WETH price the lending pool reads as its oracle.
        ...
        // Wrap all of the player's ETH (original balance + swap proceeds) into WETH.
        weth.deposit{value: player.balance}();

        // Borrow the pool dry at the now-crashed price.
